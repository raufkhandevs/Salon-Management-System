/*
  ...
  - You are about to drop the column `name` on the `coupons` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `coupons` DROP COLUMN `name`,
    ADD COLUMN `code` VARCHAR(125) NOT NULL;

-- AlterTable
ALTER TABLE `invoices` MODIFY `coupon_id` INTEGER NULL;
